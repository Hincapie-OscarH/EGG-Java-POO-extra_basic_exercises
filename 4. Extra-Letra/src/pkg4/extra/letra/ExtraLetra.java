...
4. Dígito Verificador. Crear una clase NIF que se usará para mantener DNIs con su
    ...
    22 E
 */
package pkg4.extra.letra;

import Entidad.Verificador;
import Servicio.ServicioLetra;

public class ExtraLetra {

    public static void main(String[] args) {
        
        ServicioLetra sv = new ServicioLetra();
        Verificador verificador = new Verificador();
        sv.crearNif(verificador);
        sv.mostrar(verificador);
    }
